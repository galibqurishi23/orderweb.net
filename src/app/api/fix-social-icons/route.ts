...
export async function POST() {
    try {
        console.log('Fixing social icons to remove colorful effects...');

        // Updated template with clean social icons (no colorful hover effects)
        const cleanSocialTemplate = `
<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="utf-8">
...
<body>
    <div class="email-container">
        ...
        console.log('Social icons updated - removed colorful hover effects');

        return NextResponse.json({
            success: true,
            message: 'Social icons updated with clean, professional styling (no colorful effects)'
        });
