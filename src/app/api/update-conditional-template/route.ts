...
export async function POST() {
    try {
        console.log('Updating template to support conditional personal message...');

        // Updated template with conditional personal message section
...
<body>
    <div class="email-container">
        ...
        console.log('Template updated to support conditional personal message');

        return NextResponse.json({
            success: true,
            message: 'Template updated with conditional personal message support'
        });
